...
urlpatterns = [
    ...
    path('productosvendedor/<int:vendedor_id>/', views.lista_productos, name='lista_productos'),
    ...
    path('comprar/<int:id_inventario>/', views.comprar_producto, name='comprar_producto'),
